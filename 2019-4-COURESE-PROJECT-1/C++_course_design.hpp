...
private: 
	...
	bool input_test ;
public: 
	student ( string a , string b , int c , int d , int e ) : student_id ( a )  , student_name ( b )  ,  course_computer_vision ( c )  , 
			course_machine_learning ( d )  , course_algorithm ( e )  , course_average ( ( c + d + e ) / 3 ) { }
	student ( ) 
	{
		cout << "       " ;
		cin >> student_id ;
		...
		course_average = ( course_computer_vision + course_machine_learning + course_algorithm ) / 3 ;
